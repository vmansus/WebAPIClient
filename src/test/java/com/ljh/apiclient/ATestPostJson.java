...
//            System.setProperty("https.proxyPort", "8888");
            ...
            String uri = "http://ipv4.fiddler:8080/test/testapi2";
...
//            httppost.setConfig(config);
            ...
            String request= res.toJSONString();
...
//            System.out.println(response.getEntity().getContent().toString());
            ...
            if (code == 200) {
                ...
                JSONObject resObject= new WebAPIClientAPI().decJson(jsonObject);

//                String decResponse=new RequestHandler().decResponse(rev);
                System.out.println("原始响应为:\n\n"+resObject.toJSONString()+"\n\n");
            }
